...
With these metadata inserted into the object using `oceSetMetadata`, you can then run the following commands to export to ODF. Note if the function oce2odf is not appearing, use 'ctrl +shift +L' to load all functions. 
